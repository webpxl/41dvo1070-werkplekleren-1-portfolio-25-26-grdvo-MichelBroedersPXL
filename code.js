const projecten = [{
    hoofdAfbeelding: "./assets/tekenfoto1.jpg", primaireInfo: {
        titel: "Knik", beschrijving: `Enkele jaren geleden heb ik een Instagram-accountje (<a id="knik-link" href="https://www.instagram.com/knik.knak.knik/" target="_blank">@knik.knak.knik</a>
) gemaakt waarop ik af en toe tekeningen op deel die ik maak.`, keywords: ["Pen en papier", "Creatief", "Abstract"]
    }, secundaireInfo: [{
    ...
    hoofdAfbeelding: "./assets/takeawaysite1.png", primaireInfo: {
    ...
    hoofdAfbeelding: "./assets/navibeat1.png", primaireInfo: {
        titel: "NaviBeat",
...
for (let i = 0; i < projecten.length; i++) {
    ...
    if (i === 0) {
        projectElement.classList.add('eerste-project');
    } else if (i === projecten.length - 1) {
        projectElement.classList.add('laatste-project');
    }
